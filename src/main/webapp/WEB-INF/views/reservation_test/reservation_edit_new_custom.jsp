						...
						<div class="form-group">
							...
							<div layout-gt-xs="row">
								...
								<label>Depart date</label> <md-datepicker
									ng-model="resv.hdr.maxDepartDate" enabled 
									min-date="departminDate" md-open-on-focus></md-datepicker> </md-input-container>
						...
						<div class="col-md-9">
							...
							<div layout-gt-sm="row" class="div_nationality">
								...
								<div>
									...
									<div class="address">
										<input ng-disabled="roomDtl.isDeleted"											
											ng-model="roomDtl.gstno" pattern="^([0][1-9]|[1-2][0-9]|[3][0-9])([a-zA-Z]{5}[0-9]{4}[a-zA-Z]{1}[1-9a-zA-Z]{1}[zZ]{1}[0-9a-zA-Z]{1})+$" >
									</div>
									</md-input-container>
								</div>

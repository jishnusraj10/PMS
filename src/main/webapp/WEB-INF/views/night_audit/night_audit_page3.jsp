...
<c:set var="customEditIncludeFile"
	value="../night_audit/night_audit_page3_custom.jsp" scope="request" />
...
<script type="text/javascript"
	src="<c:url value='/resources/pms/js/angularctrl/night_audit_page3.js' />"></script>
</head>
<body class="full-width"
	ng-controller="auditPage3Controller as page3ctrl" ng-cloak id="tools">

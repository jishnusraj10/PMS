...
<c:set var="moduleTitle" value="Users" scope="request" />
<c:set var="moduleName" value="Users" scope="request" />
<c:set var="backUrl" value="/dashboard" scope="request" />
<c:set var="backBtnStatusVal" value="1" scope="request" />
<c:set var="formId" value="users" scope="request" />
<c:set var="formName" value="users" scope="request" />
<c:set var="customEditIncludeFile" value="../users/user_edit_custom.jsp"
	scope="request" />
...
<script type="text/javascript"
	src="<c:url value='/resources/pms/js/angularctrl/user.js' />"></script>
</head>
<body class="full-width" ng-controller="userController as userCtrl"
	id="tools">

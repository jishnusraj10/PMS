	...
	<div class="panel-body">
		<div class="hs_filter col-md-3">
			<div class="col-md-4 col-sm-4 col-xs-4">
				<md-checkbox ng-change="filterFunction(); gethkstatuscount()" ng-model="hk_filter.dirty"
					class="md-primary" aria-label="Checkbox 1">DIRTY</md-checkbox>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-4">
				<md-checkbox ng-change="filterFunction(); gethkstatuscount()" ng-model="hk_filter.clean"
					class="md-primary" aria-label="Checkbox 1">CLEAN</md-checkbox>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-4">
				<md-checkbox ng-change="filterFunction(); gethkstatuscount()"
		...
		<div class="col-md-7">
			...
			<div class="roomOption col-md-4">
				<select class="form-control selectOption" ng-model="rmType"
					ng-change="loadRoomDetails(); gethkstatuscount()">
...
<!-- <div class="row"> -->
			<div class="grid_div col-md-10">
				...
				<div class="tile_footer_edit"
					ng-if="room.hkStatus!=1 && room.resvStatus==1 && room.occStatus==2">RESERVED by for </div>

				</md-grid-tile-footer> </md-grid-tile> </md-grid-list>
			</div>
			<div class="room_sub_hdr col-md-2">
				<div class="room_info occ_stat row">
					<div class="rm_st">
						<span class="color_span occupied"></span>
						<div class="dtl_span">OCCUPIED</div> 
						<span class="count_bg">{{ OccupiedCount }}</span>
					</div>
					<div class="rm_st">
						<span class="color_span vacant"></span>
						<span class="dtl_span">VACANT</span> 
						<span class="count_bg">{{ VacantCount }}</span>
					</div>
<!-- 					<div class="rm_st"> -->
<!-- 						<span class="color_span reserved"></span> -->
<!-- 						<span class="dtl_span">RESERVED</span>  -->
<!-- 						<span class="count_bg"></span> -->
<!-- 					</div> -->
					<div class="rm_st">
						<span class="color_span outOfInv"></span>
						<span class="dtl_span">OUT OF INV</span> 
						<span class="count_bg">{{ OutInventoryCount }}</span>
					</div>
				</div>
				<hr />
				<div class="room_info hk_stat row">
					...
					<div class="hk_status_colors">
						...
						<div class="rm_st">
							<span class="color_span dirty"></span>
							<span class="dtl_span">DIRTY</span> 
							<span class="count_bg">{{ DirtyCount }}</span>
						</div>
						<div class="rm_st">
							<span class="color_span cleaned"></span>
							<span class="dtl_span">CLEAN</span> 
							<span class="count_bg">{{ CleanCount }}</span>
						</div>
						<div class="rm_st">
							<span class="color_span cleaning"></span>
							<span class="dtl_span">CLEANING</span> 
							<span class="count_bg">{{ CleaningCount }}</span>
						</div>
					</div>
				</div>
			</div>

									...
									<div class="addree_div">
										...
										<div class="new_chk_in_lft_div_tbl_input">
											<div class="col-sm-12">
												<div class="row">
													<md-input-container class="md-block chInp" flex-gt-sm>
													<input ng-model="checkin.dtl.gstno" maxlength="15"
														pattern="^([0][1-9]|[1-2][0-9]|[3][0-9])([a-zA-Z]{5}[0-9]{4}[a-zA-Z]{1}[1-9a-zA-Z]{1}[zZ]{1}[0-9a-zA-Z]{1})+$"
...
<div layout-gt-sm="row" class="input_div">
                  ...
                  <md-select class="md_slect_div_edit" ng-model="checkin.dtl.nationality" placeholder="country" ng-change="loadState(checkin.dtl.nationality)" required>
                  <md-option ng-repeat="country in countryList "ng-value="country.name">{{country.name}}</md-option>
				  </md-select> 
				  </md-input-container>
				  <md-input-container class="md-block chInp" flex-gt-sm>
				  <label>State<span class="red">*</span></label> 
				  <md-select class="md_slect_div_edit" ng-model="checkin.dtl.state" placeholder="state" required>

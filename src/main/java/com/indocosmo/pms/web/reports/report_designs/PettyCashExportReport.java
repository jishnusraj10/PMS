...
public class PettyCashExportReport extends AbstractPdfViewReports{
	...
	protected void buildPdfDocument(Map<String, Object> model,
		...
		if(pettyExpenseReport.size()!=0){
			...
			cell.setPhrase(new Phrase("To/By", font));
			table.addCell(cell);
			...
			for(int i=0;i<pettyExpenseReport.size();i++){
				...
				else if (pettyCash.getVoucherType().equals("CONTRAC")){
					cell.setPhrase(new Phrase("To",f));
					table.addCell(cell);
				}
				else {
			...
			for(int i=1;i<=3;i++){
				...
				if(i == 2) {
					...
					if(i == 1 ) {
						cell.setPhrase(new Phrase(String.valueOf(debitTotal), font));
						cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
					...
					if(i == 1 ) {
						...
						cell.setPhrase(new Phrase(String.valueOf(closinBlnce), font));
						cell.setBorder(Rectangle.TOP);
						cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
						table.addCell(cell);
					}

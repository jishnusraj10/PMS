...
//	remove this url2
	public static final String DASHBOARD_HOME_PAGE_URL = "dashboard/dashboard_index";
	...
	public String dashboard12(HttpServletRequest request, Model model, HttpSession session) throws Exception {
		String pageUrl = DASHBOARD_HOME_PAGE_URL;
...
//	remove this new
	...
	public String dashboardnew(HttpServletRequest request, Model model, HttpSession session) throws Exception {
		String pageUrl1 = DASHBOARD_HOME_PAGE_URL2;
		permissionObj = pageAccessPermissionService.getPermission(session, "DASHBOARD");
		SysPermissions permissionObjRequest = pageAccessPermissionService.getPermission(session, "PMS_RECPN_REQUEST");
		if (permissionObj.isCanView() && permissionObj.isIs_view_applicable()) {
			SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
			...
			pageUrl1 = SYDEF_PERMISION_DENIED_PAGE_URL;
		}
		return pageUrl1;
